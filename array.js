...
3- Favorite Movie (4)
*/
var favoriteFood = ["falafel","shawerma","mansaf","pizza","burger"];
var favoriteSport = ["football","tennis","swimming"];
var favoriteMovie = ["the mentalist","saw","friends","twilight"];
